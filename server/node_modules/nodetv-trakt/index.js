...
var API = {
	...
	account: {
		test: function(callback){
			var payload = {};
			API.post('account/test', payload, function(error, json){
	...
	calendar: {
		shows: function(callback){
			...
			API.get('user/calendar/shows.json', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		}
	},
	...
	lists: {
		add: function(list, callback){
			...
			API.post('lists/add', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
	...
	movie: {
		library: function(imdb, callback){
			...
			API.post('movie/library', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		seen: function(imdb, callback){
			...
			API.post('movie/seen', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		summaries: function(items, callback){
			...
			API.get('movie/summaries.json', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		summary: function(imdb, callback){
			...
			API.get('movie/summary.json', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		unlibrary: function(imdb, callback){
			...
			API.post('movie/unlibrary', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		unseen: function(imdb, callback){
			...
			API.post('movie/unseen', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		unwatchlist: function(imdb, callback){
			...
			API.post('movie/unwatchlist', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		watchlist: function(imdb, callback){
			...
			API.post('movie/watchlist', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});			
		}
	},
	...
	network: {
		follow: function(user, callback){
			...
			API.post('network/follow', payload, callback);
		}
	},
	...
	recommendations: {
		shows: function(callback){
			...
			API.post('recommendations/shows', payload, callback);
		}
	},
	
	server: {
		time: function(){
			API.get('server/time.json', {}, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		}
	},
	...
	show: {
		checkin: function(){
			...
			API.post('show/checkin', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		...
		episode: {
			library: function(tvdb, list, callback){
				...
				API.post('show/episode/library', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			seen: function(tvdb, season, episode, callback){
				...
				API.post('show/episode/seen', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			summary: function(tvdb, season, episode, callback){
				...
				API.get('show/episode/summary.json', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			unseen: function(tvdb, season, episode, callback){
				...
				API.post('show/episode/unseen', payload, function(error, json){	
					if (typeof(callback) == 'function') callback(error, json);
				});
			}
		...
		library: function(tvdb, callback){
			...
			API.post('show/library', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		...
		season: {
			info: function(tvdb, season, callback){
				...
				API.get('show/season.json', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			library: function(tvdb, season, callback){
				...
				API.post('show/season/library', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			seen: function(tvdb, season, callback){
				...
				API.post('show/season/seen', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			}
		},
		seasons: function(tvdb, callback){
			...
			API.get('show/seasons.json', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		seen: function(tvdb, callback){
			...
			API.post('show/seen', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		summary: function(tvdb, callback){
			...
			API.get('show/summary.json', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		unlibrary: function(tvdb, callback){
			...
			API.post('show/unlibrary', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			});
		},
		watchlist: function(shows, callback){
			...
			API.post('show/watchlist', payload, function(error, json){
				if (typeof(callback) == 'function') callback(error, json);
			})
		}
	},
	...
	user: {
		library: {
			movies: {
				all: function(callback){
					...
					API.get('user/library/movies/all.json', payload, function(error, json){
						if (typeof(callback) == 'function') callback(error, json);
					})
				}
			},
			shows: {
				all: function(callback){
					...
					API.get('user/library/shows/all.json', payload, function(error, json){
						if (typeof(callback) == 'function') callback(error, json);
					});
				}
			}
		...
		progress: {
			collected: function(callback){
				...
				API.get('user/progress/collected.json', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			},
			watched: function(tvdb, callback){
				...
				API.get('user/progress/watched.json', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			}
		},
		watchlist: {
			movies: function(callback){
				...
				API.get('user/watchlist/movies.json', payload, function(error, json){
					if (typeof(callback) == 'function') callback(error, json);
				});
			}
		}
