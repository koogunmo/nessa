...
wget http://prdownloads.sourceforge.net/netatalk/netatalk-3.1.1.tar.bz2 -O netatalk-3.1.1.tar.bz2
tar xf netatalk-3.1.1.tar.bz2
cd netatalk-3.1.1/
...
wget http://prdownloads.sourceforge.net/minidlna/minidlna-1.1.2.tar.gz -O minidlna-1.1.2.tar.gz
tar xf minidlna-1.1.2.tar.gz
cd minidlna-1.1.2/
./configure
make && make install
cd ..
