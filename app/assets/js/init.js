...
requirejs.config({
	paths: {
		...
		'ngCookies': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.0-beta.5/angular-cookies.min',
		'ngResource': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.0-beta.5/angular-resource.min',
		'ngTouch': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.0-beta.5/angular-touch.min',
