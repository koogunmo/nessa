...
requirejs.config({
	paths: {
		...
		'ngResource': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.0-beta.11/angular-resource.min',
		'ngStorage': 'libs/ng-storage.min',
		'ngTouch': 'https://ajax.googleapis.com/ajax/libs/angularjs/1.3.0-beta.11/angular-touch.min',
